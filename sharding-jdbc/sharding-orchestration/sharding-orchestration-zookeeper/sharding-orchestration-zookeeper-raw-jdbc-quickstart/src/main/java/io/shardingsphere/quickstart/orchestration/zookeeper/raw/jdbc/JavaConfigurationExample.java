...
import io.shardingsphere.quickstart.orchestration.zookeeper.raw.jdbc.factory.OrchestrationDataSourceFactory;
...
//    private static boolean loadConfigFromRegCenter = true;
    ...
    public static void main(final String[] args) throws Exception {
        DataSource dataSource = OrchestrationDataSourceFactory.newInstance(shardingType, loadConfigFromRegCenter);
