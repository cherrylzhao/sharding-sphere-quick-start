    ...
    private static String getApplicationFilePrecise() {
        switch (shardingType) {
            case SHARDING_DATABASES:
                return String.format("META-INF/%s/application-sharding-databases.xml", loadConfigFromRegCenter ? "cloud" : "local");
            case SHARDING_TABLES:
                return String.format("META-INF/%s/application-sharding-tables.xml", loadConfigFromRegCenter ? "cloud" : "local");
            ...
            case SHARDING_MASTER_SLAVE:
                return String.format("META-INF/%s/application-sharding-master-slave.xml", loadConfigFromRegCenter ? "cloud" : "local");
            default:
